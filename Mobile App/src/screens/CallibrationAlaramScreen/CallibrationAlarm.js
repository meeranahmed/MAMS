...
import { useNavigation } from "@react-navigation/native";
  ...
  export default function CallibrationAlarm() {
  ...
  useEffect(() => {
    apiServices.getCalibration().then(async (response) => {
  ...
  let reverse = History.reverse()
    return (
      <View style={styles.container}>
        <Text  style={styles.title} >Devices That Need To Be Calibrated:</Text>  

...
import { useNavigation } from "@react-navigation/native";
  ...
  export default function WarrantyAlarm() {
  ...
  useEffect(() => {
    apiServices.getWarranty().then(async (response) => {
  ...
  let reverse = History.reverse()
    return (
      <View style={styles.container}>
        <Text  style={styles.title} >Devices That Their Warranty Is About To End:</Text>  
